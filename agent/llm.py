...
from agent.utils import get_memory_content,get_project_memory,get_active_project_name,get_repo_map,read_prompt_from_file,get_llm_config
...
def get_genai_client():
    ...
    if not _genai_client:
        ...
        if settings.RAVEN_USE_VERTEX_AI == "True":
