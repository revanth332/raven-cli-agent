...
class Settings:
    SCHEMA = {
        ...
        "RAVEN_AGENT_SOFT_TURNS": (10, "int", ["RAVEN_AGENT_SOFT_TURNS", "AGENT_SOFT_TURNS"]),
        "RAVEN_AGENT_HARD_TURNS": (20, "int", ["RAVEN_AGENT_HARD_TURNS", "AGENT_HARD_TURNS"]),
        "RAVEN_AGENT_MAX_TOOL_CALLS": (40, "int", ["RAVEN_AGENT_MAX_TOOL_CALLS", "AGENT_MAX_TOOL_CALLS"]),
        "RAVEN_AGENT_MAX_NO_PROGRESS": (3, "int", ["RAVEN_AGENT_MAX_NO_PROGRESS", "AGENT_MAX_NO_PROGRESS"]),
        "RAVEN_AGENT_GRACE_TURNS": (2, "int", ["RAVEN_AGENT_GRACE_TURNS", "AGENT_GRACE_TURNS"]),
    }
